...
with open('train_data_delk.pkl', 'rb') as f:
...
val_data = val_data[:495]
val_labels = val_labels[:495]
...
for epoch in range(num_epochs):
    ...
    print(
        f'Epoch {epoch + 1}: train_loss={train_loss:.4f}, train_acc={train_acc:.4f}, val_acc={val_acc:.4f}, val_f1={val_f1:.4f}')
...
print(f'val_acc={val_acc_f1:.4f}, val_f1={val_f1_max:.4f}')
